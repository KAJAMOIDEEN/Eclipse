...
<HTML lang="en">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="Inventory.jsp">Inventory</a></li>
					<!-- <li class="nav-item mx-0 mx-lg-1"><a
      ...
      <div class="container-fluid bg-1 ">	
       <H1 class="page-section-heading text-center text-uppercase text-secondary mb-0 ">Products List</H1>
       </header>
       <hr>  
